...
This directory is the repository-local landing zone for volatile release-candidate evidence such as GitHub Actions run ids, artifact ids, artifact digests, tarball shasums, downloaded artifact paths, and command transcripts.
