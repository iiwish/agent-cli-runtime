...
- Remote GitHub Actions release-candidate branch evidence is run `28089574967` on branch target SHA `59b8c00a4ef79356fcba30fb526eab2f158bcdf3`; it proves P6-3 branch artifacts and compatibility gate evidence only. Historical run `27932628093` only proves workflow head SHA `8d7bc2a19c626caa1ad5223acbcd35df34aff18e`; historical run `27869580048` only proves commit `2f8832119b4ebdb8393077052560589a398ebf56`.
