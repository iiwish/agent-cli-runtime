...
状态：0.1.0-alpha.3 corrective pre-alpha release；P8-5 main-scoped remote evidence closure 保持包外记录
负责人：local project
最后更新：2026-06-29
...
`0.1.0-alpha.3` 是面向 package consumer 的 corrective pre-alpha release。
