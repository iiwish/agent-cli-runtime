...
状态：0.1.0-alpha.1 已发布，post-alpha evidence normalization，current-head release evidence 保持包外记录
负责人：local project
最后更新：2026-06-23
...
P3-11 current-head evidence boundary 继续约束 post-alpha evidence：易漂移发布证据必须留在包外，并且每个 workflow run 只证明自己的 `headSha`。
