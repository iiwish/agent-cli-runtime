...
- `npm run release:post-alpha:verify` compares npm registry and GitHub Release tarballs, allowing raw gzip hash differences only when unpacked package content is identical; for alpha.4 this gate remains blocked until GitHub Release `v0.1.0-alpha.4` and its tarball asset exist;
