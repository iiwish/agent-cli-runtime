...
export const CLI_SCHEMA_INVENTORY = [
  ...
  {
    schemaVersion: "agent-cli-runtime.stableSurfaceCheck.v1",
    requiredTopLevelFields: [
      "schemaVersion",
      "ok",
      "packageRoot",
    ...
    classificationFields: [
      ...
      "packagedDocs.ok",
      "diagnostics[].code",
      "boundary.repoOnlyGate",
      "boundary.stableSurfaceCheckIsRuntimePublicApi",
    ],
    redactionRules: ["repo-only gate summary", "no raw stdout/stderr", "no workflow log", "no private paths"],
  },
